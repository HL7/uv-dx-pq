<!-- DOMAIN HEADER -->
<div style="background:#f9fafb; border:1px solid #e5e7eb; border-left:4px solid #0891b2; border-radius:8px; padding:16px 20px; margin-bottom:24px;">
  <div style="font-size:.72em; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:#0891b2; margin-bottom:4px;">Domain 2</div>
  <div style="font-weight:700; color:#111827; font-size:1.1em; margin-bottom:6px;">Composition</div>
</div>
