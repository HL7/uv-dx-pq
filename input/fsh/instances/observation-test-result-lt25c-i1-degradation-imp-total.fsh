Instance: observation-test-result-lt25c-i1-degradation-imp-total
...
* valueQuantity = 0.801 '%' "% w/w"
* component.code = $cs-local-codes-drug-pq-example#IMP "Impurity"
* component.valueCodeableConcept.text = "Total Degradation Impurities"