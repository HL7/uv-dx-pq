Instance: observation-test-result-lt25c-i1-degradation-imp-unspecified
...
* valueQuantity = 0.101 '%' "% w/w"
* component.code = $cs-local-codes-drug-pq-example#IMP "Impurity"
* component.valueCodeableConcept.text = "Any Unspecified Degradation Impurity"